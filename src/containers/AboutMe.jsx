...
export default function About() {
  return (
    <body>
  <section className="jumbotron jumbotron-fluid openingBanner" style={{margin:"0%"}}>
    <div className="row">
      <article className="col align-self-center">
        <h2 className="display-3 mt-0 mb-1 text-right">Hey, I'm</h2>
        <h1 className="display-3 mt-0 mb-1 text text-right">Sally Alvarenga</h1>
        <p className="lead text-right">A young and ambitious engineer, certified in full stack web development, eager to improve my work and the work of any team I become a part of.
        </p>
      </article>
      <article className="col justify-content-left">
        <img className=" img-fluid" id="headerImage" src={openingImg}
  ...
  <div style={{marginTop: "-3px", width:"101.5%"}}>
    <img className=" img-fluid" src={topTransition} alt="transition for background"/>
  </div>
  
  <section className="container" id="aboutMe">
    <h2>About Me</h2>
      <article className="row aboutMe">
          <div className=" col aboutMePhoto ">
          ...
          <section className=" col aboutMeContent">    
              ...
              <article className="text-center" id="resume">
                <a href={resumePDF} download className="btn btn-lg btn-primary"
